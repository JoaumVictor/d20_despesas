...
import { useExpensesByRange, useToggleStatus, type ExpenseWithCategory } from '@/features/expenses/api';
...
export default function ExpensesScreen() {
  ...
  const total = useMemo(() => (data ?? []).reduce((sum, e) => sum + e.price, 0), [data]);
  ...
  // Swipe horizontal troca o mês (só no modo Mês). Ref evita closure obsoleta.
      ...
      {isLoading ? (
        ...
        <View style={{ flex: 1 }} {...pan.panHandlers}>
          <SectionList
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                <MaterialCommunityIcons name="tray" size={48} color={c.border} />
